...
class Migration(migrations.Migration):
    ...
    replaces = [(b'thing', '0001_initial'), (b'thing', '0002_auto_20160126_1128'), (b'thing', '0003_esitoken'), (b'thing', '0004_auto_20170515_0055'), (b'thing', '0005_auto_20170515_0200'), (b'thing', '0006_esitoken_expires_on'), (b'thing', '0007_auto_20170515_0235'), (b'thing', '0008_auto_20170515_0237'), (b'thing', '0009_auto_20170515_0239'), (b'thing', '0010_esitoken_added'), (b'thing', '0011_auto_20170515_0254'), (b'thing', '0012_remove_esitoken_expires'), (b'thing', '0013_esitoken_character'), (b'thing', '0014_auto_20170515_2050'), (b'thing', '0015_auto_20170516_1856')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(to='thing.Character')),
                ('to_characters', models.ManyToManyField(related_name='+', to=b'thing.Character')),
            ],
            options={
                'ordering': ('-sent_date',),
            },
        ...
        migrations.AddField(
            ...
            name='implants',
            field=models.ManyToManyField(to=b'thing.Implant'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='characterdetails',
        ...
        migrations.AddField(
            model_name='campaign',
            name='characters',
            field=models.ManyToManyField(to=b'thing.Character', null=True, blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='campaign',
            name='corp_wallets',
            field=models.ManyToManyField(to=b'thing.CorpWallet', null=True, blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='campaign',
        ...
        migrations.AddField(
            model_name='apikey',
            name='characters',
            field=models.ManyToManyField(related_name='apikeys', to=b'thing.Character'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='apikey',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refresh_token', models.CharField(default='', max_length=320)),
                ('corporationID', models.IntegerField(default=None, null=True)),
                ('token_type', models.CharField(default='', max_length=32)),
                ('added', models.DateTimeField(default=datetime.datetime(2017, 5, 15, 2, 49, 34, 563790), auto_now_add=True)),
                ('user', models.ForeignKey(default=1, to=settings.AUTH_USER_MODEL)),
                ('character', models.OneToOneField(related_name='esitoken', null=True, to='thing.Character')),
            ],
            options={
            },
            bases=(models.Model,),
